...
function connectToMetamask(){
  ...
  $("#broadcastthis").click(function() {
    myContract.methods.make_broadcast_simple($("#thebroadcast").val()).send({from:
      current_account},
...
$(document).ready(function() {
  ...
  $("#compose").click(function(){ console.log("clicked compose") });
  // $("#compose").draggable();
   $("#compose").toggle();
  // const composeHTML = 
